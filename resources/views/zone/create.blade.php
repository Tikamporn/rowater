...
<div class="w3-row">
	...
	<div class="w3-col m4 s4 w3-round-xlarge">
		...
		<br>
		<form class="w3-container" role="form" method="POST" action="{{ url('/zone/addAction') }}" accept-charset="utf-8" onsubmit="return confirm('Do you really want to submit the form?');">
