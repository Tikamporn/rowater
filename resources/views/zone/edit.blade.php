		...
		<form class="w3-container" role="form" method="POST" action="{{ url('/zone/storeAction') }}" accept-charset="utf-8" onsubmit="return confirm('Do you really want to submit the form?');">
			<table class="w3-table">
			  	<tr>
	                ...
	                <td><input class="w3-border w3-round w3-input w3-left" name="name" type="text" value="{{$zone->name}}"></td>
				</tr>
				<tr>
	                <td class="w3-right">คำอธิบาย :</td>
	                <td><textarea rows="4" cols="40%" name="detail">{{$zone->detail}}</textarea></td>
				</tr>
			</table>				
			<br>
